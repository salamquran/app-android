...
public class LmsGroup_Adaptor extends RecyclerView.Adapter<LmsGroup_Adaptor.ViewHolder>{
  ...
  private Context context;
    ...
    public LmsGroup_Adaptor(Context context, List<LmsModel_group> model) {
