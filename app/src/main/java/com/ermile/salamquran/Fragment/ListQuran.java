 ...
 */
public class ListQuran extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View fragment_quran = inflater.inflate(R.layout.fragment_list_quran, container, false);
        ...
        adapterTab.addFragment(new ListQuran_Detail(true) , "لیست سوره ها");
        adapterTab.addFragment(new ListQuran_Detail(false) , "لیست جزء ها");
