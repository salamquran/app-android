...
public final class ArabicDatabaseUtils_Factory implements Factory<ArabicDatabaseUtils> {
  ...
  public ArabicDatabaseUtils_Factory(Provider<Context> contextProvider,
  ...
  public ArabicDatabaseUtils get() {
    return new ArabicDatabaseUtils(contextProvider.get(), quranInfoProvider.get(), quranFileUtilsProvider.get());
  }

  public static ArabicDatabaseUtils_Factory create(Provider<Context> contextProvider,
      Provider<QuranInfo> quranInfoProvider, Provider<QuranFileUtils> quranFileUtilsProvider) {
    return new ArabicDatabaseUtils_Factory(contextProvider, quranInfoProvider, quranFileUtilsProvider);
  }

  public static ArabicDatabaseUtils newArabicDatabaseUtils(Context context, QuranInfo quranInfo,
