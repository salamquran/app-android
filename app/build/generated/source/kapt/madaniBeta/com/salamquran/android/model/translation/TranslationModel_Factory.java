...
public final class TranslationModel_Factory implements Factory<TranslationModel> {
  ...
  public TranslationModel_Factory(Provider<Context> appContextProvider,
  ...
  public static TranslationModel_Factory create(Provider<Context> appContextProvider,
      Provider<QuranFileUtils> quranFileUtilsProvider) {
    return new TranslationModel_Factory(appContextProvider, quranFileUtilsProvider);
  }

  public static TranslationModel newTranslationModel(Context appContext,
