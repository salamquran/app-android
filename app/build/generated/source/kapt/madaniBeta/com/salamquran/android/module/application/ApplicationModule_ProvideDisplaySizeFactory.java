...
public final class ApplicationModule_ProvideDisplaySizeFactory implements Factory<DisplaySize> {
  ...
  public ApplicationModule_ProvideDisplaySizeFactory(ApplicationModule module,
  ...
  public DisplaySize get() {
    return proxyProvideDisplaySize(module, displayProvider.get());
  }

  public static ApplicationModule_ProvideDisplaySizeFactory create(ApplicationModule module,
      Provider<Display> displayProvider) {
  ...
  public static DisplaySize proxyProvideDisplaySize(ApplicationModule instance, Display display) {
    return Preconditions.checkNotNull(instance.provideDisplaySize(display), "Cannot return null from a non-@Nullable @Provides method");}
}
