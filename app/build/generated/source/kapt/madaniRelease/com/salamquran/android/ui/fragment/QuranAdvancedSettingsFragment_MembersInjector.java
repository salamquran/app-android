...
public final class QuranAdvancedSettingsFragment_MembersInjector implements MembersInjector<QuranAdvancedSettingsFragment> {
  ...
  public static MembersInjector<QuranAdvancedSettingsFragment> create(
      ...
      Provider<QuranFileUtils> quranFileUtilsProvider,
      Provider<QuranScreenInfo> quranScreenInfoProvider) {
    return new QuranAdvancedSettingsFragment_MembersInjector(bookmarkImportExportModelProvider, quranFileUtilsProvider, quranScreenInfoProvider);}
  ...
  public static void injectBookmarkImportExportModel(QuranAdvancedSettingsFragment instance,
      BookmarkImportExportModel bookmarkImportExportModel) {
    instance.bookmarkImportExportModel = bookmarkImportExportModel;
  }

  public static void injectQuranFileUtils(QuranAdvancedSettingsFragment instance,
      QuranFileUtils quranFileUtils) {
    instance.quranFileUtils = quranFileUtils;
  }

  public static void injectQuranScreenInfo(QuranAdvancedSettingsFragment instance,
