...
public final class TranslationManagerActivity_MembersInjector implements MembersInjector<TranslationManagerActivity> {
  ...
  public static MembersInjector<TranslationManagerActivity> create(
      Provider<TranslationManagerPresenter> presenterProvider,
      Provider<QuranFileUtils> quranFileUtilsProvider) {
    return new TranslationManagerActivity_MembersInjector(presenterProvider, quranFileUtilsProvider);}
  ...
  public static void injectPresenter(TranslationManagerActivity instance,
      TranslationManagerPresenter presenter) {
    instance.presenter = presenter;
  }

  public static void injectQuranFileUtils(TranslationManagerActivity instance,
