...
public final class QuranImportPresenter_Factory implements Factory<QuranImportPresenter> {
  ...
  public QuranImportPresenter_Factory(Provider<Context> appContextProvider,
  ...
  public QuranImportPresenter get() {
    return new QuranImportPresenter(appContextProvider.get(), modelProvider.get(), bookmarkModelProvider.get());
  }

  public static QuranImportPresenter_Factory create(Provider<Context> appContextProvider,
      Provider<BookmarkImportExportModel> modelProvider,
      Provider<BookmarkModel> bookmarkModelProvider) {
    return new QuranImportPresenter_Factory(appContextProvider, modelProvider, bookmarkModelProvider);
  }

  public static QuranImportPresenter newQuranImportPresenter(Context appContext,
